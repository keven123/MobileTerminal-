...
@class KeyboardSettingsViewController;
...
@private
  ...
  KeyboardSettingsViewController* keyboardSettings;
}
...
@property(nonatomic, retain) KeyboardSettingsViewController* keyboardSettings;
